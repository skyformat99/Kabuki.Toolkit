...
@file        ~/tests/grfx3D/Shading.java
@date        May 20, 2014
@author      Cale McCollough
@copyright   Cale McCollough
@license     http://opensource.org/licenses/MIT
@brief       This file contains the hal.tests.grfx3D class.
*/
using hal.*;
...
class ShadingDemo extends hal.grfx3d.SoftwareEngine
{
    ...
    public void renderShapeSolid (Shape3d renderShape, Graphics page)
    ...
    public void removeBackFacesAndShade (Shape3d renderShape)
    ...
    public void drawTriangle (d3.Point_d one, d3.Point_d two, d3.Point_d three, Colour colour, Graphics page)
    ...
    public void drawTopTriangle (d3.Point_d one, d3.Point_d two, d3.Point_d three, Colour colour, Graphics page)
    ...
    public void drawBottomTriangle (d3.Point_d one, d3.Point_d two, d3.Point_d three, Colour colour, Graphics page)
    {  float deltaXright, deltaXleft, xStart, xEnd, height, right, left;
        page.setColour (colour);
        if (three.x<two.x)
        {  float temp = two.x;
