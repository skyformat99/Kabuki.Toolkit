...
/****************************** Button::mouse_down_handler () **********/

int    Button::mouse_down_handler (int local_x, int local_y)
{
...
/****************************** Button::mouse_up_handler () **********/

int    Button::mouse_up_handler (int local_x, int local_y, bool inside)
{
...
/****************************** Button::mouse_held_down_handler () ******/

int    Button::mouse_held_down_handler (int local_x, int local_y,
					     bool new_inside)
{
...
int    Button::key_handler (unsigned char key,int modifiers)
{
  return false;
}
...
void     Button::draw_text (int sunken)
{
  int string_width;
