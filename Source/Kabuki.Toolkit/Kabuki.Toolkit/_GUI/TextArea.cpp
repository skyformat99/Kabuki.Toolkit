/** Underscore
    @file       /.../Kabuki.Toolkit/_G2D/TextArea.h
...
{
    /**  */
    class TextArea : Cell, Scrollable
    {
        /**  */
        ...
        /**  */
        TextArea (int leftEdge, int topEdge, int width, int height, _G.Color_i bgColor) :
            base (leftEdge, topEdge, width, height, bgColor)
        {
        }
   
        /**  */
        TextArea (int leftEdge, int topEdge, int width, int height, _G.Color_i bgColor, Font initFont) :
            base (leftEdge, topEdge, width, height, bgColor)
        {      
            if (initFont != null)
        ...
        string text;
        _G.Color_i defaultTextColor = _G.Color_i.Black;
