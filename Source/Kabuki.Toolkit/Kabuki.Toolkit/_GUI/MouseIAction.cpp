/****************************************************************************
  ...
  ---------------------------
     ...
     mouse_iaction - GLUI Mouse Interaction control class
...
/********************** Mouse_Interaction::mouse_down_handler () ******/

int    Mouse_Interaction::mouse_down_handler (int local_x, int local_y)
{
...
/**************************** Mouse_Interaction::mouse_up_handler () */

int    Mouse_Interaction::mouse_up_handler (int local_x, int local_y, bool inside)
{
...
/****************************** Mouse_Interaction::mouse_held_down_handler () ******/

int    Mouse_Interaction::mouse_held_down_handler (int local_x, int local_y,
							bool inside)
{  
...
/****************************** Mouse_Interaction::Draw () **********/

void    Mouse_Interaction::Draw (int x, int y)
{
...
/************************************ Mouse_Interaction::update_size () **********/

void   Mouse_Interaction::update_size (void)
{
  if (NOT glui)
    return;
...
/****************************** Mouse_Interaction::special_handler () **********/

int    Mouse_Interaction::special_handler (int key,int modifiers)
{
...
/****************************** Mouse_Interaction::draw_active_area () **********/

void    Mouse_Interaction::draw_active_area (void)
{ 
  ...
  /* glViewport (this->x_abs , glui->mainPanel->h - this->y_abs - this->h,*/
