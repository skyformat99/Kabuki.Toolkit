/** Kabuki.Toolkit
    @file       /.../Kabuki.Toolkit/_G/String.h
...
{
    const _G.Color DefaultTextColour = _G.Color.black;
    ...
    String (int leftEdge, int bottomEdge) : Cell (leftEdge, bottomEdge, 0, 0)
    {
    }

    /**  */
    String (int leftEdge, int bottomEdge, std::string initText)
    {
    ...
    /**  */
    String (int leftEdge, int bottomEdge, std::string initText, int initFontSize)
    {
        base (leftEdge, bottomEdge, 0, 0);
    ...
    /**  */
    String (int leftEdge, int bottomEdge, std::string initText, _G.Colour_i initTextColour)
    {
        base (leftEdge, bottomEdge, 0, 0);
        text = initText;
    ...
    /**  */
    String (int leftEdge, int bottomEdge, std::string initText, _G.Colour_i initTextColour, int initFontSize)
    {
        base (leftEdge, bottomEdge, 0, 0);
        text = initText;
        numCharictors = text.numChars ();
    ...
    /**  */
    void AddText (std::string newString)
    {
    ...
    /**  */
    std::string AddTextOverflow (std::string newString)
    {
    ...
    /**  */
    bool InsertText (std::string newString, int here)
    {
    ...
    /**  */
    void setFontColour (Color newColour)
    {
        colour = newColour;
    }
    ...
    Color colour = DefaultTextColour;
