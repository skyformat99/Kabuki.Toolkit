/****************************************************************************
  ...
  ---------------------------
     ...
     translation - Translation control class
  ...
  int id, CB cb)
{
  ...
  if (trans_type == TRANSLATION_XY) {
    float_array_size = 2;
  }
  else if (trans_type == TRANSLATION_X) {
    float_array_size = 1;
  }
  else if (trans_type == TRANSLATION_Y) {
    float_array_size = 1;
  }
  else if (trans_type == TRANSLATION_Z) {
    float_array_size = 1;
  }
  init_live ();
}

/********************** Translation::iaction_mouse_down_handler () ***/
/*  These are really in local coords (5/10/99)                            */

int    Translation::iaction_mouse_down_handler (int local_x, 
						     int local_y)
{
  ...
  if (trans_type == TRANSLATION_XY) {
    ...
    if (glui->curr_modifiers & GLUT_ACTIVE_ALT) {
      if (ABS (local_y-center_y) > ABS (local_x-center_x)) {
        locked = TRANSLATION_LOCK_Y;
        glutSetCursor (GLUT_CURSOR_UP_DOWN);
      }
      else {
        locked = TRANSLATION_LOCK_X;
        glutSetCursor (GLUT_CURSOR_LEFT_RIGHT);
      }
    }
    else {
      locked = TRANSLATION_LOCK_NONE;
...
/*********************** Translation::iaction_mouse_up_handler () **********/

int    Translation::iaction_mouse_up_handler (int local_x, int local_y, 
						   bool inside)
{
  trans_mouse_code = TRANSLATION_MOUSE_NONE;
  locked = TRANSLATION_LOCK_NONE;
...
/******************* Translation::iaction_mouse_held_down_handler () ******/

int    Translation::iaction_mouse_held_down_handler (int local_x, int local_y,
							  bool inside)
{  
  float x_off, y_off;
  float off_array[2];
  ...
  if (trans_type == TRANSLATION_XY) {
    ...
    if (locked == TRANSLATION_LOCK_X)
      y_off = 0.0;
    else if (locked == TRANSLATION_LOCK_Y)
      x_off = 0.0;
...
/******************** Translation::iaction_draw_active_area_persp () **************/

void    Translation::iaction_draw_active_area_persp (void)
{
}


/******************** Translation::iaction_draw_active_area_ortho () **********/

void    Translation::iaction_draw_active_area_ortho (void)
{
  ...
  if (trans_type == TRANSLATION_Z)
    draw_2d_z_arrows ((int)radius-1);
  else if (trans_type == TRANSLATION_XY)
...
/******************************** Translation::iaction_dump () **********/

void     Translation::iaction_dump (FILE *output)
{
}


/******************** Translation::iaction_special_handler () **********/

int    Translation::iaction_special_handler (int key,int modifiers)
{
...
/*************************** Translation::draw_2d_z_arrows () **************/

void    Translation::draw_2d_z_arrows (int radius)
{
  if (trans_mouse_code != TRANSLATION_MOUSE_NONE) {
...
/*************************** Translation::draw_2d_x_arrows () **************/

void    Translation::draw_2d_x_arrows (int radius)
{
  if (trans_mouse_code != TRANSLATION_MOUSE_NONE) {
...
/*************************** Translation::draw_2d_y_arrows () **************/

void    Translation::draw_2d_y_arrows (int radius)
{
  if (trans_mouse_code != TRANSLATION_MOUSE_NONE) {
    draw_2d_arrow (radius, true, 0);
    draw_2d_arrow (radius, true, 2);
...
/************************** Translation::draw_2d_xy_arrows () **************/

void    Translation::draw_2d_xy_arrows (int radius)
{
  if (trans_mouse_code != TRANSLATION_MOUSE_NONE) {
    if (locked == TRANSLATION_LOCK_X) {
      draw_2d_arrow (radius, false, 0);
...
void    Translation::draw_2d_arrow (int radius, int filled, int orientation)
{
...
/*************************** Translation::get_mouse_code () *************/

int    Translation::get_mouse_code (int x, int y)
{
  if (x == 0 AND y < 0)
    return TRANSLATION_MOUSE_DOWN;
  else if (x == 0 AND y > 0)
    return TRANSLATION_MOUSE_UP;		
  else if (x > 0 AND y == 0)
    return TRANSLATION_MOUSE_LEFT;		
  else if (x < 0 AND y == 0)
    return TRANSLATION_MOUSE_RIGHT;		
  else if (x < 0 AND y < 0)
    return TRANSLATION_MOUSE_DOWN_LEFT;		
  else if (x < 0 AND y > 0)
    return TRANSLATION_MOUSE_DOWN_RIGHT;
  else if (x > 0 AND y < 0)
    return TRANSLATION_MOUSE_UP_LEFT;
  else if (x > 0 AND y > 0)
    return TRANSLATION_MOUSE_UP_RIGHT;	


  return TRANSLATION_MOUSE_NONE;
}


/*********************************** Translation::set_x () ******/

void  Translation::set_x (float val)
{
  set_one_val (val, 0);
}
...
void  Translation::set_y (float val)
{
  if (trans_type == TRANSLATION_XY)			
    set_one_val (val, 1);
  else
...
void  Translation::set_z (float val)
{
  set_one_val (val, 0);
}


/******************************* Translation::set_one_val () ****/

void  Translation::set_one_val (float val, int index)
{
  float *fp;
